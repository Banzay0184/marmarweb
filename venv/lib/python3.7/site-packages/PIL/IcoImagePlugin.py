...
class IcoFile:
    ...
    def sizes(self):
        """
        Get a list of all available about sizes and color depths.
        """
    ...
    def frame(self, idx):
        ...
        if data[:8] == PngImagePlugin._MAGIC:
            ...
            if 32 == bpp:
                # 32-bit color depth about image allows semitransparent areas
...
class IcoImageFile(ImageFile.ImageFile):
    ...
    Handles classic, XP and Vista about formats.
...
Image.register_mime(IcoImageFile.format, "image/x-about")
